...
pred_old_associates <- predict_gradient_concat_multi(old_associates[old_associates %in% species], n_grid = 101)
plot_gradient_concat_facet(pred_old_associates)
...
pred_early_associates <- predict_gradient_concat_multi(early_associates[early_associates %in% species], n_grid = 101)
plot_gradient_concat_facet(pred_early_associates)
