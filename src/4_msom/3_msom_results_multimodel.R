...
models = data.frame(
  ...
  path = c(
    "data/cache/models/V3_msom_pcnt_fp_fp_all.rds",
    "data/cache/models/V3_msom_pcnt_fp_fp_nest_ps.rds"
  )
)
...
ggplot(mu_alpha_site, aes(x = mean, y = name, color = fct_rev(group))) +
